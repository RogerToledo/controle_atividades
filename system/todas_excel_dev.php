<?php
    ...
    $arquivo = "todas-atividades-$dtxls.xls";
    ...
    $html .= "<td width='55'><b>Esforco</b></td>";
    ...
    if(!$read->getResult()):
            ...
            foreach($read->getResult() as $ativ):
                ...
                $ini = new model;
                $tempIni = $ini->calcTempoInicio($ativ_id, $ativ_data_inicio, $ativ_hora_inicio);
                $html .= "<td>{$tempIni}</td>";
                
                $html .= "<td>{$ativ_motivo_sla}</td>";
                
                $esf = new model;
                $esforco = $esf->calcEsforco($ativ_corrente_sla, $tempIni);
                $html .= "<td>{$esforco}</td>";
