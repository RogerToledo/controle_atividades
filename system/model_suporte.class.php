    ...
    class modelSuporte {
            ...
            if( $_SERVER['REQUEST_METHOD']=='POST' ):
                ...
                if( isset( $_SESSION['hash'] ) && $_SESSION['hash'] == $hash ):
                    ...
                    if(isset($this->Data)):
                        unset($this->Data['submit']);
                        //var_dump($this->Data);
                        $this->Data['ativ_sup_data_inicio'] = (empty($this->Data['ativ_sup_data_inicio'])? NULL : $this->Data['ativ_sup_data_inicio']);
                        $this->Data['ativ_sup_hora_inicio'] = (empty($this->Data['ativ_sup_hora_inicio'])? NULL : $this->Data['ativ_sup_hora_inicio']);
                        $this->Data['ativ_sup_data_termino'] = (empty($this->Data['ativ_sup_data_termino'])? NULL : $this->Data['ativ_sup_data_termino']);
                        $this->Data['ativ_sup_data_prioridade'] = (empty($this->Data['ativ_sup_data_prioridade'])? NULL : $this->Data['ativ_sup_data_prioridade']);
                        ...
                        if(!empty($this->Data['ativ_sup_data_prioridade']) || !empty($this->Data['usr_id_prioridade']) || !empty($this->Data['ativ_sup_motivo_prioridade'])):
                            $this->Data['ativ_sup_flag_prioridade'] = 1;
                        else:
                            $this->Data['ativ_sup_flag_prioridade'] = 0;
                        endif;
                        
                        
                        
                        if(!is_null($this->Data['ativ_sup_data_termino'])):
                            if(strtotime($this->Data['ativ_sup_data_inicio']) > strtotime($this->Data['ativ_sup_data_termino'])):
                                ...
                                if(empty($this->Data['ativ_sup_solucao'])):
                                ...
                                elseif($this->Data['ativ_sup_solucao'] == '.' || $this->Data['ativ_sup_solucao'] == '..' || $this->Data['ativ_sup_solucao'] == '...' || $this->Data['ativ_sup_solucao'] == '-' || $this->Data['ativ_sup_solucao'] == ',' || $this->Data['ativ_sup_solucao'] == ';' ):
                                ...
                                elseif(empty($this->Data['ativ_sup_data_inicio']) || empty($this->Data['ativ_sup_hora_inicio']) || empty($this->Data['ativ_sup_hora_termino']) || is_null($this->Data['usr_id']) ):
                                    ...
                                    if(strtotime($this->Data['ativ_sup_data_inicio']) == strtotime($this->Data['ativ_sup_data_termino'])):
                                        if(strtotime($this->Data['ativ_sup_hora_inicio']) >= strtotime($this->Data['ativ_sup_hora_termino'])):
                                            ...
                                            if(!is_null($this->Data['ativ_sup_data_prioridade']) || !empty($this->Data['usr_id_prioridade']) || !empty($this->Data['ativ_sup_motivo_prioridade'])):
                                                if(is_null($this->Data['ativ_sup_data_prioridade']) || empty($this->Data['usr_id_prioridade']) || empty($this->Data['ativ_sup_motivo_prioridade'])):
                                               ...
                                               $create = new Create;
                                                $create->ExeCreate('tb_atividades_sup', $this->Data);
            ...
            if( $_SERVER['REQUEST_METHOD']=='POST' ):
                ...
                if( isset( $_SESSION['hash'] ) && $_SESSION['hash'] == $hash ):
                    ...
                    if(isset($this->Data)):
                        ...
                        if(!empty($this->Data['ativ_sup_data_termino'])):
                            if(strtotime($this->Data['ativ_sup_data_inicio']) > strtotime($this->Data['ativ_sup_data_termino'])):
                                $this->Result = "<div class='alert alert-warning alert-dismissable'><a href='#' class='close' data-dismiss='alert' aria-label='close'>×</a><strong>Data inválida: </strong>Data Encerramento não pode ser menor que a Data Inicio.</div>";
                                ...
                                elseif(empty($this->Data['ativ_sup_data_inicio']) || empty($this->Data['ativ_sup_hora_inicio']) || empty($this->Data['ativ_sup_hora_termino']) || empty($this->Data['usr_id']) ):
                                ...
                                elseif($this->Data['ativ_sup_flag_prioridade'] == 1 && (empty($this->Data['ativ_sup_data_prioridade']) || empty($this->Data['usr_id_prioridade']) || empty($this->Data['ativ_sup_motivo_prioridade']))): 
                                ...
                                elseif((int)$this->Data['ativ_sup_corrente_sla'] > (int)SLA_SUP):
                                    if(empty($this->Data['ativ_sup_motivo_sla'])):
                                        ...
                                        unset($this->Data['ativ_sup_sla']);
                                        $update = new Update;

                                        $update->ExeUpdate('tb_atividades_sup', $this->Data, "WHERE ativ_sup_id=:id", ":id={$this->Data['ativ_sup_id']}");

                                        if($update->getResult()):
                                            $this->Result = "<div class='alert alert-info alert-dismissable'><a href='#' class='close' data-dismiss='alert' aria-label='close'>×</a><strong>Atividade: </strong>#{$this->Data['ativ_sup_id']} alterada com sucesso.</div>";
                                        else:
                                            $this->Result = "<div class='alert alert-danger alert-dismissable'><a href='#' class='close' data-dismiss='alert' aria-label='close'>×</a><strong>Falha na Alteração: </strong>#{$this->Data['ativ_sup_id']} não foi alterada.</div>";
                                        endif; 
                                    endif;  
                                    
                                else: 
                                    if($this->Data['ativ_sup_tp_entrada'] != 'SAC'):
                                        $this->Data['ativ_sup_sac'] = '';
                                    endif;
                ...
                if( isset( $_SESSION['hash'] ) && $_SESSION['hash'] == $hash ):
                    ...
                    if(isset($this->Data)):
                        ...
                        $query_novo =    "SELECT
                                          ...
                                          FROM tb_sla sla
                                          RIGHT JOIN tb_atividades_sup ativ
                                                ON sla.ativ_sup_id = ativ.ativ_sup_id
                                                WHERE ativ.ativ_sup_id = :id
                                          ORDER BY sla.sla_id DESC
                                          LIMIT 1";

                        $read = new Read;
                        $read->FullRead($query_novo, "id={$this->Data['ativ_sup_id']}");
                        ...
                        $query_total = "SELECT
                                        ...
                                        FROM 
                                            tb_sla
                                        WHERE
                                            ativ_sup_id = :id AND sla_tipo = 0";

                        $read->FullRead($query_total, "id={$this->Data['ativ_sup_id']}");
        ...
        function udt_motivo($Data){
            ...
            if(isset($this->Data)):
                ...
                $update->ExeUpdate('tb_sla', $this->Data, "WHERE ativ_sup_id=:id", ":id={$_SESSION['ativ_sup_id']}");   
        ...
        *************************************************************************************/
        ...
        public function calcSla($id, $dTermino = null, $hTermino = null) {
            ...
            if($this->Dias == 0 && $this->DtEntrada == $this->DtTermino):
        ...
        private function setData($id, $dTermino = null, $hTermino = null) {
            ...
            if(is_null($dTermino)):
				$readSla = new Read;
				$readSla->FullRead("SELECT ativ_sup_data_entrada AS dtEntrada, ativ_sup_data_termino AS dtTermino, ativ_sup_hora_entrada AS hrEntrada, ativ_sup_hora_termino AS hrTermino FROM tb_atividades_sup WHERE ativ_sup_id = :id", "id={$this->Id}");
				...
				$readSla = new Read;
				$readSla->FullRead("SELECT ativ_sup_data_entrada AS dtEntrada, ativ_sup_hora_entrada AS hrEntrada FROM tb_atividades_sup WHERE ativ_sup_id = :id", "id={$this->Id}");
				//var_dump($readSla->getResult());
				if($readSla->getResult()):
					$this->DtEntrada = $readSla->getResult()[0]['dtEntrada'];
					$this->HrEntrada = $readSla->getResult()[0]['hrEntrada'];
