...
<html lang="pt-br">
    <head>
        ...
        <title>Softplan | Integração</title>
    ...
    <body>
        ...
        <div class="container-fluid">            
            <h2>Integração <small> Atividades Encerradas</small></h2>
            <div class="btn-group" style="padding-bottom: 15px;">
                <a class="btn btn-default" href="integracao_abertas.php">Abertas</a>
            </div>
            <!-- Paginator -->
            <?php
                $queryFechado = "SELECT
                                 ...
                                 ORDER BY 
                                        ati.ativ_data_termino DESC,
                                        ati.ativ_hora_termino DESC,
                                        ati.ativ_id DESC";
                    ...
                    <?php    
                        ...
                        if(!$results):
                            ...
                            for($i = 0; $i < count($results->data[0]); $i++):
                                ...
                                echo "<tr>";
                                if($activ['ativ_flag_prioridade'] == 1):
                                   echo "<td style='background-color: #CDBE70'>{$activ['ativ_id']}</td>"; 
                                else:
                                   echo "<td>{$activ['ativ_id']}</td>"; 
                                endif;                                 
                                echo "<td>{$activ['tpati_tipo']}</td>";                                
                                $ativ_desc_limit = Check::Chars($activ['ativ_desc'],60);
                                echo "<td>{$ativ_desc_limit}</td>";
                                echo "<td>{$activ['tpati_criticidade']}</td>";
                                echo "<td>{$activ['usr_nome']}</td>";
                                echo "<td>{$activ['cli_codigo']}</td>";
                                echo "<td>{$activ['ativ_tp_entrada']} {$activ['ativ_sac']}</td>";
                                echo "<td>{$activ['tpate_desc']}</td>";
                                $ativ_data_entrada = Check::DataTela($activ['ativ_data_entrada']);
                                echo "<td>{$ativ_data_entrada}   {$activ['ativ_hora_entrada']}</td>";   
                                
                                $ativ_data_inicio = Check::DataTela($activ['ativ_data_inicio']);
                                echo "<td>{$ativ_data_inicio}   {$activ['ativ_hora_inicio']}</td>";
                                
                                $ativ_data_termino = Check::DataTela($activ['ativ_data_termino']);
                                echo "<td>{$ativ_data_termino}   {$activ['ativ_hora_termino']}</td>";
                                
                                $tpati_sla = (is_null($activ['tpati_sla']) || !isset($activ['tpati_sla']) ? '00:00:00' : $activ['tpati_sla']);
                                                                 
                                $ativ_corrente_sla = (is_null($activ['ativ_corrente_sla']) || !isset($activ['ativ_corrente_sla']) ? '00:00:00' : $activ['ativ_corrente_sla']);
                                ...
                                $esf = new Play;
                                echo "<td>{$esf->somaTempo($activ['ativ_id'])}</td>";
                                
                                echo "<td>";
                                    if($_SESSION['usr_sist_1'] == 9):
                                        echo "<button type='button' class='btn btn-info btn-xs glyphicon glyphicon-pencil' data-toggle='modal' data-target='#modalAlteraAtiv{$activ['ativ_id']}' name='udt_atividade'></button>";
                                    elseif($_SESSION['usr_sist_1'] == 1):
                                        echo "<button type='button' class='btn btn-warning btn-xs glyphicon glyphicon-file' data-toggle='modal' data-target='#modalAlteraAtiv{$activ['ativ_id']}' name='udt_atividade'></button>";     
                                    else:
                                        echo "<button type='button' class='btn btn-warning btn-xs glyphicon glyphicon-file' data-toggle='modal' data-target='#modalAlteraAtiv{$activ['ativ_id']}' name='udt_atividade'></button>";     
                                    endif;
                                echo"</td>";
