...
class Create {
    ...
    private function Execute() {
        ...
        try {
            ...
            Erro("<div class='alert alert-danger alert-dismissable'><a href='#' class='close' data-dismiss='alert' aria-label='close'>×</a><strong>Erro ao cadastrar: </strong> {$e->getMessage()}'</div>");
        }
    }
