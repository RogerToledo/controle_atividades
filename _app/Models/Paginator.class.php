...
//include_once "C:\wamp\www\controle_integracao\_app\Models\Paginator.class.php";
...
class Paginator {
    ...
    $read->FullRead($this->_query);
     
    $this->_total = $read->getRowCount();
     
    }
    
    //LIMIT DATA
    //all it does is limits the data returned and returns everything as $result object
    public function getData( $limit, $page = 1 ) { //set default argument values
        $read = new Read;    
        $this->_limit = $limit;
        $this->_page = $page;
