...
class Check {
    ...
    /**
     * <b>Tranforma Banco:</b> Transforma uma data no formato DD/MM/YY em uma data no formato DATE!
     * @param STRING $Name = Data em (d/m/Y) ou (d/m/Y H:i:s)
     * @return STRING = $Data = Data no formato Date!
     */
    ...
    /**
     * <b>Tranforma Data:</b> Transforma uma data no formato YYYY-MM-DD em uma data no formato DD/MM/YY!
     * @param STRING $Name = Data em (YY-mm-dd) ou (d/m/Y)
     * @return STRING = $Data = Data no formato timestamp!
     */
     ...
     */
    public static function NewPass($tamanho = 4, $maiusculas = false, $numeros = true, $simbolos = false) {
    ...
    /**
     * <b>calcSla:</b> Calcula SLA 
     * @param INT $idAtiv = Id da atividade
     * 
     */
    public static function calcSla($idAtiv){
        self::$Id = $idAtiv;
        
        
    }
    
    public static function fixCaracter($texto){
        $acento    = array("á", "à", "â", "ã", "ä", "é", "è", "ê", "ë", "í", "ì", "î", "ï", "ó", "ò", "ô", "õ", "ö", "ú", "ù", "û", "ü", "ç", "Á", "À", "Â", "Ã", "Ä", "É", "È", "Ê", "Ë", "Í", "Ì", "Î", "Ï", "Ó", "Ò", "Ô", "Õ", "Ö", "Ú", "Ù", "Û", "Ü", "Ç", "–");
        
        $semAcento = array("a", "a", "a", "a", "a", "e", "e", "e", "e", "i", "i", "i", "i", "o", "o", "o", "o", "o", "u", "u", "u", "u", "c", "A", "A", "A", "A", "A", "E", "E", "E", "E", "I", "I", "I", "I", "O", "O", "O", "O", "O", "U", "U", "U", "U", "C", "-");
        
        $txtCorrigido = str_replace($acento,$semAcento,$texto);
        
        return $txtCorrigido;
    }
    
    public static function checkSla($sla, $tempo) {
        $sla = (is_null($sla) ? '00:00:00' : $sla);
        $slaP = explode(':', $sla);
        $slaS = $slaP[0] * 3600 + $slaP[1] * 60 + $slaP[2];
        
        $tempoP = explode(':', $tempo);
        $tempoS = $tempoP[0] * 3600 + $tempoP[1] * 60 + $tempoP[2];
        
        if($slaS > $tempoS || $slaS == 0):
            return 0;
        else:
            return 1;
        endif;
